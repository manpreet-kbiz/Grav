...
return [
    ...
    'timestamp' => 1706165976,
    'checksum' => 'fcb394a256c1b59e26244a9e21bbc2a0',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/api_blog' => [
                'file' => 'user/plugins/api_blog/blueprints.yaml',
                'modified' => 1704953800
            ],
            'plugins/chat_gpt' => [
                'file' => 'user/plugins/chat_gpt/blueprints.yaml',
                'modified' => 1704096410
            ],
            'plugins/email' => [
        ...
        'user/themes' => [
            ...
            'themes/quarkcustom' => [
                'file' => 'user/themes/quarkcustom/blueprints.yaml',
                'modified' => 1702279962
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.quarkcustom.production-mode' => [
                'type' => 'toggle',
                'label' => 'Production mode',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quarkcustom.production-mode',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.grid-size' => [
                'type' => 'select',
                'label' => 'THEME_QUARK.ADMIN.GRID_SIZE',
                'size' => 'small',
                'options' => [
                ...
                'name' => 'themes.quarkcustom.grid-size',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.custom_logo' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.quarkcustom.custom_logo',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.custom_logo_mobile' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.quarkcustom.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quarkcustom.header-fixed',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quarkcustom.header-animated',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quarkcustom.header-dark',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quarkcustom.header-transparent',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quarkcustom.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.quarkcustom.blog-page',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.spectre' => [
                'type' => '_parent',
                'name' => 'themes.quarkcustom.spectre',
                'form_field' => false
            ],
            'themes.quarkcustom.spectre.exp' => [
                'type' => 'toggle',
                'label' => 'Experimentals CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quarkcustom.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.quarkcustom.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quarkcustom.spectre.icons',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'api_blog' => 'plugins.api_blog',
                'chat_gpt' => [
                    'enabled' => 'plugins.chat_gpt.enabled',
                    'api_key' => 'plugins.chat_gpt.api_key'
                ],
                'email' => [
            ...
            'themes' => [
                ...
                'quarkcustom' => [
                    'production-mode' => 'themes.quarkcustom.production-mode',
                    'grid-size' => 'themes.quarkcustom.grid-size',
                    'custom_logo' => 'themes.quarkcustom.custom_logo',
                    'custom_logo_mobile' => 'themes.quarkcustom.custom_logo_mobile',
                    'header-fixed' => 'themes.quarkcustom.header-fixed',
                    'header-animated' => 'themes.quarkcustom.header-animated',
                    'header-dark' => 'themes.quarkcustom.header-dark',
                    'header-transparent' => 'themes.quarkcustom.header-transparent',
                    'sticky-footer' => 'themes.quarkcustom.sticky-footer',
                    'blog-page' => 'themes.quarkcustom.blog-page',
                    'spectre' => [
                        'exp' => 'themes.quarkcustom.spectre.exp',
                        'icons' => 'themes.quarkcustom.spectre.icons'
                    ]
                ]
            ]
        ],
