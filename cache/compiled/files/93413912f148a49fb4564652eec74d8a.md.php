...
return [
    ...
    'filename' => 'C:/xampp8.1/htdocs/grav-admin/user/pages/04.jobs/scale-clerk-qx7-yyvw3/job.md',
    'modified' => 1706790029,
    'size' => 2902,
    'data' => [
        'header' => [
...
taxonomy:
    ...
    tag:
        - \'Food and Beverage\'',
        'markdown' => '<p><span style="font-family: inherit; font-size: 0.875rem;">Gentis Solutions is seeking a Scale Clerk to join our team. This contract-to-hire position is with one of our clients interested in full-time consultants. The ideal candidates will have the required skills listed below and will be eligible and open to being hired by our client at the end of the project\'s duration. If you are qualified, make sure you apply below.</span><br></p>
